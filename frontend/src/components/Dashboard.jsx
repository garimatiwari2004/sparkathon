...
export default function Dashboard() {
  return (
    <div className="flex flex-col  p-6 bg-gray-100 min-h-screen pt-16">
      <h2 className="text-3xl font-bold text-blue-700 m-6">Welcome to Your Dashboard</h2>

      {/* Past Purchases */}
      <section className="bg-white shadow p-4 rounded mb-6 cursor-not-allowed">
      ...
      {/* ESG Score */}
      <section className="bg-white shadow p-4 rounded cursor-not-allowed">
